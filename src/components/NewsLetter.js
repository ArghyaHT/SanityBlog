       ...
       <article>
        ...
        <article>
            <form>
                ...
                className='w-full py-2 px-4 rounded shadow mb-4 bg-transparent border-slate-200
                 placeholder-slate-300 text-slate-300 tracking-wide' />
                <button type='submit' className='bg-white py-2 px-8 rounded shadow
                text-slate-800 tracking-wide hover:opacity-75 transition-all duration-200 w-full md:w-auto'>Subscribe</button>
                {/*buttondown, covertkit */}
            </form>
        </article>
       </div>
    </section>
